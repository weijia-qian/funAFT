...
The default lambda grid is 100 exponentially spaced values from 1e3 to
1e4.
...
ggplot(df_plot, aes(x = s)) +
  ...
  geom_line(aes(y = beta_hat, color = "Estimated β(s)"), linewidth = 1) +
...
$$
  \log T_i = Z_i^\top \gamma +
    \int_S F\{s, X_i(s)\}\,ds + \sigma \varepsilon_i,
$$
...
<img src="man/figures/README-afAFT-plot-1.png" width="100%" />
